...
set fileencodings=utf-8,gbk,gb18030,gb2312,utf-16,big5,euc-jp,euc-kr,latin1
...
:function InsertTemplate()
  ...
  let name=expand("%:r")
	...
	elseif suffix=='cpp'||suffix=='c'
		...
		call append(line("."),"\#include \"".name.".h\"")
  elseif suffix=='hpp'||suffix=='h'
    call setline("1","\#pragma once")
		...
		call append(line(".")+4,"")
		call append(line(".")+5,"")
		call append(line(".")+6,"\#endif //!__".toupper(name)."_".toupper(suffix)."__")
    normal 6G
	endif
:endfunction
"********************************基本设置******************************"
